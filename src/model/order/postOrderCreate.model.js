...
exports.OrderPostCreate = void 0;
var jwt = require("jsonwebtoken");
var regex_1 = require("../../constant/regex/regex");
var OrderPostCreate = /** @class */ (function () {
    function OrderPostCreate(req) {
        ...
        if (req.body.product_id) {
            if (!regex_1.ONLYNUMBER.test(req.body.product_id))
    ...
    return OrderPostCreate;
}());
exports.OrderPostCreate = OrderPostCreate;
